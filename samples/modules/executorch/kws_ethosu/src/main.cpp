 ...
 *
 * Keyword Spotting (KWS) Application using executorch with Ethos-U NPU
 *
 * This application demonstrates running a keyword spotting CNN model
 * on the Ethos-U NPU using executorch runtime with static input data.
 */
...
int main(void) {
  printk("\n========================================\n");
  printk("executorch Keyword Spotting Demo\n");
  printk("========================================\n\n");
