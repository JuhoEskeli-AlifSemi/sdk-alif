...
#define CIMAGE_X                (560)
#define CIMAGE_Y                (560)
#define CIMAGE_COLOR_CORRECTION (0)   // Changed to 0, as currently running grayscale
#define CIMAGE_SW_GAIN_CONTROL  (0)   // Changed to 0, as current API does not support the commands sent by software gain control
#define CIMAGE_USE_RGB565       (0)
#define CIMAGE_RGB_WIDTH_MAX    CIMAGE_X
#define CIMAGE_RGB_HEIGHT_MAX   CIMAGE_Y
#else
