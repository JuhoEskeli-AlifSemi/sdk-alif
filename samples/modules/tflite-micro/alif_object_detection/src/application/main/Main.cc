...
//west build -b alif_e7_dk/ae722f80f55d5xx/rtss_hp samples/modules/tflite-micro/alif_object_detection -DEXTRA_DTC_OVERLAY_FILE="boards/serial_camera_arx3a0.overlay" -S ethos-u55-enable
